...
registerRoute(
  ...
  ({ url }) => url.origin === self.location.origin && /\.(jpe?g|png|svg|ico)$/i.test(url.pathname), //ini sudah dirubah
  //url.pathname.endsWith('.png'), ini defautlnya // Customize this strategy as needed, e.g., by changing to CacheFirst.
