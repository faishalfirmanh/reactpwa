...
function ArrivedItemDetails({itemArrived}){
  return(
    <div key={itemArrived.id} className="px-4 relative card group">
      <div
        ...
        <img
          src={itemArrived.image1}
          alt=""
          className="w-full h-full object-cover object-center"
        />
      </div>
      <h5 className="text-lg font-semibold mt-4">{itemArrived.name}</h5>
      <span className="">{numberFormat(itemArrived.price)}</span>
...
export default ArrivedItemDetails
